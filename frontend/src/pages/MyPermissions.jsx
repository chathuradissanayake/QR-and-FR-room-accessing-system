...
const MyPermissions = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <p className="text-lg text-gray-500">Loading your permissions...</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col min-h-screen px-6 py-10 bg-gray-50 md:px-16">
      <Toaster position="top-center" reverseOrder={false} />
      {/* Title Section */}
      <div className="flex items-center w-full max-w-md mx-auto mb-8 space-x-2">
        <Link to="/" className="flex items-center">
          <GoChevronLeft className="text-gray-600 cursor-pointer" />
        </Link>
        <h1 className="font-semibold text-gray-900 text-m">My Permissions</h1>
      </div>
