...
const PermissionsApproved = ({ room, roomcode, door, branch, entryTime, exitTime, date }) => {


  return (
    <div>
      <div className="bg-green-50 shadow rounded-lg pt-3 pb-3 pl-5 pr-5  ">
          <div>
...
export default PermissionsApproved
